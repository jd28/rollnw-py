...
template <typename T>
T* create_object_from_json_helper(nb::handle h)
{
    auto j = nb::cast<nlohmann::json>(h);
...
void init_object_components(nb::module_& nw);

void init_objects_base(nb::module_& nw)
{
    nb::enum_<nw::ObjectID>(nw, "ObjectID");
    // nw.attr("OBJECT_INVALID") = nw::object_invalid;

    nb::enum_<nw::ObjectType>(nw, "ObjectType")
    ...
    nb::class_<nw::ObjectHandle>(nw, "ObjectHandle")
        .def(nb::init<>())
    ...
    nb::class_<nw::ObjectBase>(nw, "ObjectBase")
        .def("handle", &nw::ObjectBase::handle);
}

void init_objects_area(nb::module_& nw)
{
    nb::enum_<nw::AreaFlags>(nw, "AreaFlags")
    ...
    nb::class_<nw::AreaScripts>(nw, "AreaScripts")
        .def(nb::init<>())
    ...
    nb::class_<nw::AreaWeather>(nw, "AreaWeather")
        .def(nb::init<>())
    ...
    nb::class_<nw::AreaTile>(nw, "AreaTile")
        .def(nb::init<>())
    ...
    nb::class_<nw::Area, nw::ObjectBase>(nw, "Area")
        .def(nb::init<>())
...
void init_objects_creature(nb::module_& nw)
{
    nb::class_<nw::CreatureScripts>(nw, "CreatureScripts")
    ...
    nb::class_<nw::Creature, nw::ObjectBase>(nw, "Creature")
        .def(nb::init<>())

        .def_static("from_dict", &create_object_from_json_helper<nw::Creature>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Creature>, nb::rv_policy::reference)
        ...
        .def("save", &nw::Creature::save, nb::arg("path"), nb::arg("format") = "json")
        ...
        .def_prop_ro(
            "equipment", [](const nw::Creature& self) { return &self.equipment; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "history", [](const nw::Creature& self) { return &self.history; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "inventory", [](const nw::Creature& c) { return &c.inventory; }, nb::rv_policy::reference_internal)
...
void init_objects_door(nb::module_& nw)
{
    nb::enum_<nw::DoorAnimationState>(nw, "DoorAnimationState")
    ...
    nb::class_<nw::DoorScripts>(nw, "DoorScripts")
    ...
    nb::class_<nw::Door, nw::ObjectBase>(nw, "Door")
        .def(nb::init<>())
        ...
        .def("save", &nw::Door::save, nb::arg("path"), nb::arg("format") = "json")

        .def_static("from_dict", &create_object_from_json_helper<nw::Door>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Door>, nb::rv_policy::reference)
...
void init_objects_encounter(nb::module_& nw)
{
    nb::class_<nw::EncounterScripts>(nw, "EncounterScripts")
    ...
    nb::class_<nw::SpawnCreature>(nw, "SpawnCreature")
    ...
    nb::class_<nw::SpawnPoint>(nw, "SpawnPoint")
        .def_rw("orientation", &nw::SpawnPoint::orientation)
        .def_rw("position", &nw::SpawnPoint::position);

    nb::class_<nw::Encounter, nw::ObjectBase>(nw, "Encounter")
        .def(nb::init<>())
        ...
        .def_static("from_dict", &create_object_from_json_helper<nw::Encounter>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Encounter>, nb::rv_policy::reference)

        .def("save", &nw::Encounter::save, nb::arg("path"), nb::arg("format") = "json")
...
void init_objects_item(nb::module_& nw)
{
    nb::enum_<nw::ItemModelType>(nw, "ItemModelType")
    ...
    nb::enum_<nw::ItemColors::type>(nw, "ItemColors")
    ...
    nb::enum_<nw::ItemModelParts::type>(nw, "ItemModelParts")
    ...
    nb::class_<nw::ItemProperty>(nw, "ItemProperty")
    ...
    nb::class_<nw::Item, nw::ObjectBase>(nw, "Item")
        .def(nb::init<>())
        ...
        .def("get_icon_by_part", &nw::Item::get_icon_by_part,
            nb::arg("part") = nw::ItemModelParts::model1, nb::arg("female") = false)

        .def_ro_static("json_archive_version", &nw::Item::json_archive_version)
        .def_ro_static("object_type", &nw::Item::object_type)

        .def_static("from_dict", &create_object_from_json_helper<nw::Item>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Item>, nb::rv_policy::reference)

        .def("save", &nw::Item::save, nb::arg("path"), nb::arg("format") = "json")
        ...
        .def_prop_ro(
            "inventory", [](const nw::Item& i) { return &i.inventory; }, nb::rv_policy::reference_internal)
...
void init_objects_module(nb::module_& nw)
{
    nb::class_<nw::ModuleScripts>(nw, "ModuleScripts")
    ...
    nb::class_<nw::Module, nw::ObjectBase>(nw, "Module")
        .def(nb::init<>())
        ...
        .def("get_area", [](nw::Module& self, size_t index) { return self.get_area(index); }, nb::rv_policy::reference_internal)
        ...
        .def("__iter__", [](nw::Module& self) {
                ...
                return nb::make_iterator(nb::type<std::vector<nw::Area*>>(), "AreaIterator", areas.begin(), areas.end()); }, nb::keep_alive<0, 1>())
...
void init_objects_placeable(nb::module_& nw)
{
    nb::enum_<nw::PlaceableAnimationState>(nw, "PlaceableAnimationState")
    ...
    nb::class_<nw::PlaceableScripts>(nw, "PlaceableScripts")
    ...
    nb::class_<nw::Placeable, nw::ObjectBase>(nw, "Placeable")
        .def(nb::init<>())
        ...
        .def_static("from_dict", &create_object_from_json_helper<nw::Placeable>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Placeable>, nb::rv_policy::reference)

        .def("save", &nw::Placeable::save, nb::arg("path"), nb::arg("format") = "json")
        ...
        .def_prop_ro(
            "inventory", [](const nw::Placeable& s) { return &s.inventory; }, nb::rv_policy::reference_internal)
...
void init_objects_player(nb::module_& nw)
{
    nb::class_<nw::Player, nw::Creature>(nw, "Player")
        ...
        .def("save", &nw::Player::save, nb::arg("path"), nb::arg("format") = "json")

        .def_static("from_dict", &create_object_from_json_helper<nw::Player>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Player>, nb::rv_policy::reference);
}

void init_objects_sound(nb::module_& nw)
{
    nb::class_<nw::Sound, nw::ObjectBase>(nw, "Sound")
        .def(nb::init<>())
        ...
        .def_static("from_dict", &create_object_from_json_helper<nw::Sound>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Sound>, nb::rv_policy::reference)

        .def("save", &nw::Sound::save, nb::arg("path"), nb::arg("format") = "json")
...
void init_objects_store(nb::module_& nw)
{
    nb::class_<nw::StoreScripts>(nw, "StoreScripts")
        .def_rw("on_closed", &nw::StoreScripts::on_closed)
        .def_rw("on_opened", &nw::StoreScripts::on_opened);

    nb::class_<nw::Store, nw::ObjectBase>(nw, "Store")
        .def(nb::init<>())
        ...
        .def_static("from_dict", &create_object_from_json_helper<nw::Store>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Store>, nb::rv_policy::reference)

        .def("save", &nw::Store::save, nb::arg("path"), nb::arg("format") = "json")

        .def_rw("common", &nw::Store::common)

        .def_prop_ro(
            "armor", [](const nw::Store& s) { return &s.inventory.armor; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "miscellaneous", [](const nw::Store& s) { return &s.inventory.miscellaneous; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "potions", [](const nw::Store& s) { return &s.inventory.potions; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "rings", [](const nw::Store& s) { return &s.inventory.rings; }, nb::rv_policy::reference_internal)
        .def_prop_ro(
            "weapons", [](const nw::Store& s) { return &s.inventory.weapons; }, nb::rv_policy::reference_internal)
...
void init_object_trigger(nb::module_& nw)
{
    nb::class_<nw::TriggerScripts>(nw, "TriggerScripts")
    ...
    nb::class_<nw::Trigger, nw::ObjectBase>(nw, "Trigger")
        .def(nb::init<>())
        ...
        .def_static("from_dict", &create_object_from_json_helper<nw::Trigger>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Trigger>, nb::rv_policy::reference)

        .def("save", &nw::Trigger::save, nb::arg("path"), nb::arg("format") = "json")
...
void init_object_waypoint(nb::module_& nw)
{
    nb::class_<nw::Waypoint, nw::ObjectBase>(nw, "Waypoint")
        .def(nb::init<>())

        .def_ro_static("json_archive_version", &nw::Waypoint::json_archive_version)
        .def_ro_static("object_type", &nw::Waypoint::object_type)

        .def_static("from_dict", &create_object_from_json_helper<nw::Waypoint>, nb::rv_policy::reference)
        .def_static("from_file", &create_object_from_file_helper<nw::Waypoint>, nb::rv_policy::reference)

        .def("to_dict", &to_json_helper<nw::Waypoint>)

        .def("save", &nw::Waypoint::save, nb::arg("path"), nb::arg("format") = "json")
