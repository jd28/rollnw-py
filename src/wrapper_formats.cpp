...
void init_formats_dialog(nb::module_& nw)
{
    nb::enum_<nw::DialogNodeType>(nw, "DialogNodeType")
        .value("entry", nw::DialogNodeType::entry)
        .value("reply", nw::DialogNodeType::reply);

    nb::enum_<nw::DialogAnimation>(nw, "DialogAnimation")
    ...
    nb::class_<nw::DialogPtr>(nw, "DialogPtr")
        .def_ro("parent", &nw::DialogPtr::parent, nb::rv_policy::reference_internal)
        .def_ro("type", &nw::DialogPtr::type)
        .def_ro("node", &nw::DialogPtr::node, nb::rv_policy::reference_internal)
        ...
        .def("add_string", &nw::DialogPtr::add_string,
            nb::arg("value"),
            nb::arg("lang") = nw::LanguageID::english,
            nb::arg("feminine") = false,
            nb::rv_policy::reference_internal)
    ...
    nb::class_<nw::DialogNode>(nw, "DialogNode")
        .def_ro("parent", &nw::DialogNode::parent, nb::rv_policy::reference_internal)
...
void init_formats_ini(nb::module_& nw)
{
    nb::class_<nw::Ini>(nw, "Ini")
...
void init_formats_image(nb::module_& nw)
{
    nb::class_<nw::Image>(nw, "Image")
        .def(nb::init<const std::filesystem::path&>())
        .def("channels", &nw::Image::channels)
        .def("data", [](const nw::Image& self) {
            size_t size = self.width() * self.height() * self.channels();
            return nb::bytes(reinterpret_cast<char*>(self.data()), size);
        })
...
void init_formats_palette(nb::module_& nw)
{
    nb::enum_<nw::PaletteNodeType>(nw, "PaletteNodeType")
    ...
    nb::class_<nw::PaletteTreeNode>(nw, "PaletteTreeNode")
    ...
    nb::class_<nw::Palette>(nw, "Palette")
        ...
        .def("save", [](const nw::Palette& self, const std::string& path, const std::string& format) {
            ...
            } }, nb::arg("path"), nb::arg("format") = "json")
...
void init_formats_plt(nb::module_& nw)
{
    nb::enum_<nw::PltLayer>(nw, "PltLayer")
    ...
    nb::class_<nw::PltPixel>(nw, "PltPixel")
        .def_ro("color", &nw::PltPixel::color)
        .def_ro("layer", &nw::PltPixel::layer);

    nb::class_<nw::PltColors>(nw, "PltColors")
        .def(nb::init<>())
        .def_ro("colors", &nw::PltColors::data);

    nb::class_<nw::Plt>(nw, "Plt")
        .def(nb::init<const std::filesystem::path&>())
...
void init_formats_twoda(nb::module_& nw)
{
    nb::class_<nw::TwoDARowView>(nw, "TwoDARowView")
    ...
    nb::class_<nw::StaticTwoDA>(nw, "StaticTwoDA")
