...
{
    nb::class_<nw::model::NodeFlags>(nw, "MdlNodeFlags")
    ...
    nb::class_<nw::model::NodeType>(nw, "MdlNodeType")
    ...
    nb::class_<nw::model::EmitterFlag>(nw, "MdlEmitterFlag")
    ...
    nb::enum_<nw::model::GeometryType>(nw, "MdlGeometryType")
    ...
    nb::enum_<nw::model::ModelClass>(nw, "MdlClassification")
    ...
    nb::class_<nw::model::ControllerType>(nw, "MdlControllerType")
    ...
    nb::class_<nw::model::ControllerKey>(nw, "MdlControllerKey>")
    ...
    nb::class_<nw::model::Face>(nw, "MdlFace")
    ...
    nb::class_<nw::model::Node>(nw, "MdlNode")
    ...
    nb::class_<nw::model::DummyNode, nw::model::Node>(nw, "MdlDummyNode");

    nb::class_<nw::model::CameraNode, nw::model::Node>(nw, "MdlCameraNode");

    nb::class_<nw::model::EmitterNode, nw::model::Node>(nw, "MdlEmitterNode")
    ...
    nb::class_<nw::model::LightNode, nw::model::Node>(nw, "MdlLightNode")
    ...
    nb::class_<nw::model::PatchNode, nw::model::Node>(nw, "MdlPatchNode");

    nb::class_<nw::model::ReferenceNode, nw::model::Node>(nw, "MdlReferenceNode")
        .def_rw("refmodel", &nw::model::ReferenceNode::refmodel)
        .def_rw("reattachable", &nw::model::ReferenceNode::reattachable);

    nb::class_<nw::model::Vertex>(nw, "Vertex")
    ...
    nb::class_<nw::model::TrimeshNode, nw::model::Node>(nw, "MdlTrimeshNode")
    ...
    nb::class_<nw::model::SkinVertex>(nw, "SkinVertex")
    ...
    nb::class_<nw::model::SkinNode, nw::model::TrimeshNode>(nw, "MdlSkinNode")
        .def_rw("vertices", &nw::model::SkinNode::vertices);

    nb::class_<nw::model::AnimeshNode, nw::model::TrimeshNode>(nw, "MdlAnimeshNode")
    ...
    nb::class_<nw::model::DanglymeshNode, nw::model::TrimeshNode>(nw, "MdlDanglymeshNode")
    ...
    nb::class_<nw::model::AABBEntry>(nw, "MdlAABBEntry")
    ...
    nb::class_<nw::model::AABBNode, nw::model::TrimeshNode>(nw, "MdlAABBNode")
        .def_rw("entries", &nw::model::AABBNode::entries);

    // -- Geometry ----------------------------------------------------------------

    nb::class_<nw::model::Geometry>(nw, "MdlGeometry")
        ...
        .def("nodes", [](const nw::model::Geometry& self) {
            ...
            for (auto& ptr : self.nodes) {
                auto pyobj = nb::cast(*ptr, nb::rv_policy::reference);
                pylist.append(pyobj);
            }
            return nb::iter(pylist);
        });

    nb::class_<nw::model::AnimationEvent>(nw, "MdlAnimationEvent")
        .def_rw("time", &nw::model::AnimationEvent::time)
        .def_rw("name", &nw::model::AnimationEvent::name);

    nb::class_<nw::model::Animation, nw::model::Geometry>(nw, "MdlAnimation")
    ...
    nb::class_<nw::model::Model, nw::model::Geometry>(nw, "MdlModel")
        ...
        .def_prop_ro("supermodel", [](const nw::model::Model& self) { return self.supermodel.get(); }, nb::rv_policy::reference)
    ...
    nb::class_<nw::model::Mdl>(nw, "Mdl")
        ...
        .def_prop_ro("model", [](const nw::model::Mdl& self) { return &self.model; }, nb::rv_policy::reference);
