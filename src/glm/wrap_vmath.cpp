...
void wrap_Vector3(nb::module_& m)
{
    nb::class_<glm::vec3> t(m, "Vector3");

    t.def("__init__", []() {
        return glm::vec3(0.0f, 0.0f, 0.0f);
    });
    t.def(nb::init<float, float, float>());
...
{
    nb::class_<glm::quat> t(m, "Quaternion");

    t.def("__init__", []() {
        return glm::quat(1.0f, 0.0f, 0.0f, 0.0f);
    });
    t.def(nb::init<float, float, float, float>());
...
void wrap_Matrix4(nb::module_& m_)
{
    nb::class_<glm::mat4> t(m_, "Matrix4");
...
void wrap_Transform(nb::module_& m)
{
    nb::class_<Transform> t(m, "Transform");

    t.def(nb::init<>());
    t.def(nb::init<glm::vec3, glm::quat, glm::vec3>());
...
void wrap_Vector2(nb::module_& m)
{
    nb::class_<glm::vec2> t(m, "Vector2");

    t.def("__init__", []() {
        return glm::vec2(0.0f, 0.0f);
    });
    t.def(nb::init<float, float>());
...
void wrap_Vector4(nb::module_& m)
{
    nb::class_<glm::vec4> t(m, "Vector4");
...
void wrap_Ray(nb::module_& m)
{
    nb::class_<Ray> t(m, "Ray");

    t.def(nb::init<>());
    t.def(nb::init<glm::vec3, glm::vec3>());
