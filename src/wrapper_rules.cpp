...
{
    nb::enum_<nw::AttackResult>(nw, "AttackResult")
    ...
    nb::class_<nw::AttackData>(nw, "AttackData")
    ...
    nb::enum_<nw::DamageCategory>(nw, "DamageCategory")
    ...
    nb::class_<nw::EffectID>(nw, "EffectID")
        .def_ro("version", &nw::EffectID::version)
        .def_ro("index", &nw::EffectID::index);

    nb::class_<nw::EffectHandle>(nw, "EffectHandle")
